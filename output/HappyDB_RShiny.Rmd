...
hm_data <- read_csv("C:/Users/dtdlu/OneDrive/Documents/GitHub/ads-fall2023-project1-dtl2129/output/processed_moments.csv")
...
hm_data <- hm_data[complete.cases(hm_data[, c("wid")]),]

hm_data[is.na(hm_data$wid),]

```

```{r}
write.csv(hm_data, "C:/Users/dtdlu/OneDrive/Documents/GitHub/ads-fall2023-project1-dtl2129/output/processed_moments_w_demog.csv")
```
